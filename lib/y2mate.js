 ...
 * @param {String} quality (available: `144p`, `240p`, `360p`, `480p`, `720p`, `1080p`, `1440p`, `2160p`)
 * @param {String} type (available: `mp3`, `mp4`)
 * @param {String} bitrate (available for video: `144`, `240`, `360`, `480`, `720`, `1080`, `1440`, `2160`)
 * (available for audio: `128`)
...
export {
   ...
   * @param {String} server (available: `id4`, `en60`, `en61`, `en68`)
   */
  yta: function(url, resol = '128kbps', server = 'en154') { 
   ...
   * @param {String} server (available: `id4`, `en60`, `en61`, `en68`)
   */
  ytv: function(url, resol = '360p', server = 'en154') { 
