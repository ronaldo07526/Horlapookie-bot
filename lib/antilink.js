...
import { getAntilink, incrementWarningCount, resetWarningCount, isSudo } from './index.js';
import fs from 'fs';
...
try {
    ...
    WARN_COUNT = config.default.WARN_COUNT || 3;
} catch (error) {
    console.log('Using default WARN_COUNT of 3');
}
